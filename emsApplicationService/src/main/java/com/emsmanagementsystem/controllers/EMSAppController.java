...
public class EMSAppController {
    ...
    public Employee getEmployeeById(@RequestParam(value = "id") String id){
    ...
    public Employee updateEmployeeById(@RequestParam(value = "id") String id, @RequestBody Employee employee){
        return emsAppService.updateEmployeeById(id, employee);
    }

    @DeleteMapping(path = "/deleteEmployeeById/{id}")
    public void deleteEmployeeById(@RequestParam(value = "id") String id){
        emsAppService.deleteEmployeeById(id);
    }

    @GetMapping(path = "/getEmpWrapperById/{id}")
    public EntityWrapper getNetSalaryById(@RequestParam(value = "id") String id){
    ...
    public Insurance updateInsuranceById(@RequestParam(value = "id") String id, @RequestBody Insurance insurance){
        return emsAppService.updateInsuranceById(id, insurance);
    }

    @DeleteMapping(path = "/deleteInsuranceById/{id}")
    public void deleteInsuranceById(@RequestParam(value = "id") String id){
    ...
    public Dependent updateDependentById(@RequestParam(value = "id") String id, @RequestBody Dependent dependent){
        return emsAppService.updateDependentById(id, dependent);
    }

    @DeleteMapping(path = "/deleteDependentById/{id}")
    public void deleteDependentById(@RequestParam(value = "id") String id){
